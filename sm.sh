...
install_libsodium(){
	cd /root
	wget -N -P  /root https://raw.githubusercontent.com/CxiaoyuN/jy-panel/master/libsodium-1.0.11.tar.gz
...
install_ss_libev(){
	cd /root 
	wget -N -P  /root https://raw.githubusercontent.com/CxiaoyuN/jy-panel/master/shadowsocks-libev-3.0.3.tar.gz
...
install_ss_mgr(){
	...
	install_libsodium
	install_ss_for_each
	git clone https://github.com/CxiaoyuN/shadowsocks-manager.git "/root/shadowsocks-manager"
...
ss_mgr_s(){
	install_ss_mgr
	mkdir /root/.ssmgr
	wget -N -P  /root/.ssmgr/ https://raw.githubusercontent.com/CxiaoyuN/jy-panel/master/ss.yml
	cd /root/shadowsocks-manager/
...
ss_mgr_m(){
	ss_mgr_s
	cd /root/shadowsocks-manager/
	wget -N -P  /root/.ssmgr/ https://raw.githubusercontent.com/CxiaoyuN/jy-panel/master/webgui.yml
